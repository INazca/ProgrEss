...
class MicrotaskEvaluation extends Controller {
    ...
    constructor(data) {
        super(data, new EditorView(`<span class="evaluate-font-color">Verbessern Sie wenn nötig die folgende Lösung zu: </span>` + data.task, data.evaluation.code, true, data.controlType));
