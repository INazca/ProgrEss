...
class MicrotaskEvaluation extends Controller {
    ...
    constructor(data) {
        super(data, new EditorView(`<div class="evaluate-font-color">Bewerten Sie die Lösung von Teilnehmer ${data.evaluation.editor}</div>` + data.task, data.evaluation.code, true, data.controlType));
