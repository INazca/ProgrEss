...
class TypeEvaluation extends Controller {
    ...
    constructor(data) {
        super(data, new EditorSolutionView(`<div class="evaluate-font-color">Bewerten Sie die folgende Lösung zu: </div>` + data.task, data.code, data.evaluation.type, data.controlType));
